...
namespace CompanyCrudTwo.FactoryClasses
{
		...
		where TEntity : EntityBase2, IEntity2
	{
		...
		public EntityFactoryBase2(string entityName, CompanyCrudTwo.EntityType typeOfEntity, bool isInHierarchy) : base(entityName, (int)typeOfEntity)
		{
		...
		/// <inheritdoc/>
		public override IEntity2 CreateEntityFromEntityTypeValue(int entityTypeValue) {	return GeneralEntityFactory.Create((CompanyCrudTwo.EntityType)entityTypeValue); }
	...
	{
		/// <summary>CTor</summary>
		public DepartmentEntityFactory() : base("DepartmentEntity", CompanyCrudTwo.EntityType.DepartmentEntity, false) { }
		/// <inheritdoc/>
	...
	{
		/// <summary>CTor</summary>
		public EmployeeEntityFactory() : base("EmployeeEntity", CompanyCrudTwo.EntityType.EmployeeEntity, false) { }
		/// <inheritdoc/>
	...
	public partial class GeneralEntityFactory
	{
		...
		public static IEntity2 Create(CompanyCrudTwo.EntityType entityTypeToCreate)
		{
	...
	public static class EntityFactoryFactory
	{
		...
		{
			foreach(int entityTypeValue in Enum.GetValues(typeof(CompanyCrudTwo.EntityType)))
			{
				var factory = GetFactory((CompanyCrudTwo.EntityType)entityTypeValue);
		...
		/// <summary>Gets the factory of the entity with the CompanyCrudTwo.EntityType specified</summary>
		/// <param name="typeOfEntity">The type of entity.</param>
		/// <returns>factory to use or null if not found</returns>
		public static IEntityFactory2 GetFactory(CompanyCrudTwo.EntityType typeOfEntity)
		{
			switch(typeOfEntity)
			{
				case CompanyCrudTwo.EntityType.DepartmentEntity:
					return new DepartmentEntityFactory();
				case CompanyCrudTwo.EntityType.EmployeeEntity:
	...
	{
		/// <summary>Gets the factory of the Entity type with the CompanyCrudTwo.EntityType value passed in</summary>
		...
		{
			return new DynamicRelation(leftOperand, joinType, (CompanyCrudTwo.EntityType)Enum.Parse(typeof(CompanyCrudTwo.EntityType), rightOperandEntityName, false), aliasRightOperand, onClause);
		}

		/// <inheritdoc/>
		public override IDynamicRelation CreateDynamicRelation(string leftOperandEntityName, JoinHint joinType, string rightOperandEntityName, string aliasLeftOperand, string aliasRightOperand, IPredicate onClause)
		{
			return new DynamicRelation((CompanyCrudTwo.EntityType)Enum.Parse(typeof(CompanyCrudTwo.EntityType), leftOperandEntityName, false), joinType, (CompanyCrudTwo.EntityType)Enum.Parse(typeof(CompanyCrudTwo.EntityType), rightOperandEntityName, false), aliasLeftOperand, aliasRightOperand, onClause);
		}
		
		/// <inheritdoc/>
		public override IDynamicRelation CreateDynamicRelation(IEntityFieldCore leftOperand, JoinHint joinType, string rightOperandEntityName, string aliasLeftOperand, string aliasRightOperand, IPredicate onClause)
		{
			return new DynamicRelation(leftOperand, joinType, (CompanyCrudTwo.EntityType)Enum.Parse(typeof(CompanyCrudTwo.EntityType), rightOperandEntityName, false), aliasLeftOperand, aliasRightOperand, onClause);
		}
		
		/// <inheritdoc/>
		protected override IEntityFactoryCore GetFactoryImpl(int entityTypeValue) { return EntityFactoryFactory.GetFactory((CompanyCrudTwo.EntityType)entityTypeValue); }
